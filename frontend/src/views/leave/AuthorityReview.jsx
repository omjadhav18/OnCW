...
const AuthorityReview = () => {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      try {
        setIsLoading(true);
        const response = await apiInstanceAuth.get("/authority/form-review");
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-4">
                <div className="flex items-center">
                  ...
                  <h1 className="text-2xl font-bold text-gray-800">Authority Applications Review</h1>
                </div>
              </div>
                  ...
                  {applications.length > 0 ? (
                    applications.map((app) => (
                      ...
                      >
                        ...
                        <Link
                          to={`/teacher-authority/review/detail/${app.id}`}
