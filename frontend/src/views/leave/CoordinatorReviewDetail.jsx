...
import { FileText, ChevronLeft, Check, X, AlertTriangle } from 'lucide-react';
...
const CoordinatorReviewDetail = () => {
    ...
    const handleApprove = async () => {
        ...
        navigate("/teacher-coordinator-review")
    };
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
                            <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-4">
                                <div className="flex items-center">
                                    ...
                                    <h1 className="text-2xl font-bold text-gray-800">Leave Application Review</h1>
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                <h3 className="text-lg font-semibold text-indigo-600 mb-4">Application Approved By Concerned Authority</h3>
                                <div className="p-5 bg-blue-50 rounded-lg border border-blue-200 flex items-start">
                                    <AlertTriangle size={20} className="text-blue-600 mr-3 mt-1" />
                                    <div>
                                        <p className="text-base mb-2 text-gray-800">This application is reviewed and approved by the concerned authority before coming to coordinator review.</p>
                                        <p className="text-base font-medium text-blue-700">Make Final Decision</p>
                                    </div>
                                </div>
                            </div>
                            
                            <div className="mb-8">
                                <h3 className="text-lg font-semibold text-indigo-600 mb-4">Class Coordinator Decision</h3>
                                <div className="p-5 bg-yellow-50 rounded-lg border border-yellow-200">
                                    <p className="text-base mb-4 text-gray-800">Please review the application carefully before making a decision.</p>
                            ...
                            <div className="text-center">
                                <button
                                    onClick={() => navigate('/teacher-coordinator-review')}
