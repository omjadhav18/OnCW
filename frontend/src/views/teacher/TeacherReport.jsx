...
const TeacherReport = () => {
  ...
  const downloadReport = async () => {
    ...
    try {
      // Call the API with date parameters
      const response = await apiInstanceAuth.get(
        `leave-application-teacher-within-date-range/?from_date=${fromDate}&to_date=${toDate}`,
      ...
      link.href = url;
      link.setAttribute('download', `leave_report_${fromDate}_to_${toDate}.xlsx`);
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-64"> {/* Adjust margin to match sidebar width */}
        <div className="p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-800">Teacher Reports</h1>
            <p className="text-gray-600">Download your leave applications within a specific date range</p>
          </div>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">About Teacher Reports</h3>
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    This report will contain all your leave applications within the selected date range. 
                    The Excel file includes details such as the from date, to date, and message for each leave application.
                  </p>
                </div>
              </div>
            </div>
