...
const HODReport = () => {
  ...
  const downloadReport = async () => {
    ...
    try {
      // Call the HOD-specific API with date parameters
      const response = await apiInstanceAuth.get(
        `leave-applications-within-date-range/?from_date=${fromDate}&to_date=${toDate}`,
      ...
      link.href = url;
      link.setAttribute('download', `hod_department_report_${fromDate}_to_${toDate}.xlsx`);
      ...
      console.error('Error downloading HOD report:', err);
      ...
      <div className="flex-1 ml-64"> {/* Adjust margin to match sidebar width */}
        <div className="p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Download leave applications within a specific date range for your department</p>
          </div>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">About Department Reports</h3>
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    This report contains a comprehensive overview of all leave applications within your department for the selected date range.
                    As HOD, you can use this report to track department-wide leave patterns and manage staffing effectively.
                  </p>
                </div>
              </div>
            </div>
