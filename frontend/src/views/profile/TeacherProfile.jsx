...
function TeacherProfile() {
  ...
  //     // Create updated teacher data object
  //     const updatedData = {
  //       user: {
  //         username,
  //         email,
  ...
  //     // Simulating API call to update teacher data
  //     // Replace with your actual API call
  //     setTimeout(() => {
  //       console.log('Updated teacher data:', updatedData);
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-900">{teacherId}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-500">Subject</p>
                      <p className="mt-1 text-sm text-gray-900">{subject || 'Not specified'}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-500">Qualification</p>
                      <p className="mt-1 text-sm text-gray-900">{qualification}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-500">Role</p>
                      <p className="mt-1 text-sm text-gray-900">{teacherRole}</p>
                    </div>
                  </div>
                </div>
              </div>
